...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1445866697, '1', './data/template/1_1_common_header_portal_index.tpl.php', './template/default', 'common/header_portal_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1445866697, '1', './data/template/1_1_common_header_portal_index.tpl.php', './template/default', 'common/header_portal_index')
;?>
...
<title><?php if(!empty($navtitle)) { ?><?php echo $navtitle;?> - <?php } if(empty($nobbname)) { ?> <?php echo $_G['setting']['bbname'];?> - <?php } ?> 亚洲龙舟俱乐部</title>
...
<script src="<?php echo $_G['setting']['jspath'];?>my/jquery.js?<?php echo VERHASH;?>" type="text/javascript"></script>
...
<?php } ?>
<link rel="stylesheet" type="text/css" href="<?php echo $_G['style']['tpldir'];?>/common/dragonboat_main.css?<?php echo VERHASH;?>" />	
</head>
...
</div><?php } ?><?php echo adshow("headerbanner/wp a_h");?><?php } ?>
<!--公共头部 start--><?php $mnid = getcurrentnav();?><div class="top_wrap">
     <div class="top_area">
          <div class="content"><img src="<?php echo $_G['style']['tpldir'];?>/common/images/top_banner.jpg" width="1000" height="330" border="0"></div>
</div>
<div class="nav_area">
<ul class="nav_menu cl"><?php if(is_array($_G['setting']['navs'])) foreach($_G['setting']['navs'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?>
<li <?php if($mnid == $nav['navid']) { ?>class="onhover" <?php } ?><?php echo $nav['nav'];?>></li><?php } } ?>              
</ul>
</div>
</div>
<!--公共头部 end-->
